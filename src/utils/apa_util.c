...
{
    /**
     * This switches out of M_DRAWING, which uninstalls the APA-specific drawing_lcd interrupt handler
     * and returns the background tile layer to normal tile-map behavior — i.e. back to regular
     * printf()/tile-based rendering instead of per-pixel framebuffer drawing.
     * 
